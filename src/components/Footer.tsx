...
import { footerLinks } from "@/data/wanted";

export default function Footer() {
  return (
    <footer className="bg-purple-deeper text-white">
      <div className="max-w-[1400px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.getInvolved.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-gray-300 hover:text-white transition-colors cursor-pointer flex items-center gap-2">
                    <svg className="w-3 h-3 text-teal flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.partnerWithUs.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-gray-300 hover:text-white transition-colors cursor-pointer flex items-center gap-2">
                    <svg className="w-3 h-3 text-teal flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M9 18l6-6-6-6" />
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.facebook.com/crimestoppers/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity cursor-pointer" aria-label="Follow us on Facebook">
              ...
              <a href="https://www.instagram.com/crimestopperstrust" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity cursor-pointer" aria-label="Follow us on Instagram">
              ...
              <a href="https://twitter.com/CrimestoppersUK" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity cursor-pointer" aria-label="Follow us on Twitter">
              ...
              <a href="https://www.youtube.com/user/CrimestoppersUK" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity cursor-pointer" aria-label="Follow us on YouTube">
